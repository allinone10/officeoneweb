...
<head>
    ...
    <title>Office One | Sign in</title>
</head>
<body>
                        ...
                        <div class="room-item shadow rounded overflow-hidden lg-form">
                            <div class="position-relative text-center p-2">
                                ...
                                @if (session('error'))
                                    ...
                                    <br>
                                @endif
                                <h6 class="text-start text-uppercase section-title">Login</h6>
                            </div>
                            <div class="p-4 mt-2">
                                <form method="POST" action="{{ route('client.sign-in') }}">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 text-center">
                                            Not a Member ? <a class="" href="{{ route('register') }}">Create Account</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
